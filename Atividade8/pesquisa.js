...
for (pessoas = 1; pessoas < 46; pessoas++) {
  ...
  // REGISTRANDO MAIS VELHO E MAIS NOVO
  if (pessoas === 1) {
    maisVelha = idade;
    maisNova = idade;
  }
  ...
  // REGISTRANDO A QUANTIDADE DE PESSOAS QUE RESPONDERAM PÉSSIMO E ÓTIMO E BOM
  if (opiniao === 1) {
    qtdPessimo += 1;
  } else if (opiniao === 4) {
    qtdOtimo += 1;
  ...
  // REGISTRANDO A QUANTIDADE DE HOMENS E MULHERES QUE RESPONDERAM AO QUESTIONÁRIO
  ...
  // VERIFICANDO SE TEM MAIS PESSOAS PARA RESPONDEREM
...
// CALCULANDO A MÉDIA DA IDADE E A PORCENTAGEM DE BOM E ÓTIMO
